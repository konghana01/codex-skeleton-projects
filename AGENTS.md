...
- 문서와 skill의 source of truth는 `docs/governance/governance.md`, `docs/governance/context-map.md`, `docs/skills/skill-guide.md`를 기준으로 관리합니다.
...
- Codex skill을 생성, 수정, 검토할 때는 `/skill-creator`와 `docs/skills/skill-guide.md`를 먼저 읽습니다.
